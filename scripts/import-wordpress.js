...
// ---------------------------------------------------------------------------
// Import shared pure helpers from the TypeScript module
// ---------------------------------------------------------------------------
const {
  extractPostData,
  sanitizeWordPressHtml,
} = require('../shared/services/wordpressImport.ts');

// Re-export so other scripts (e.g. fix-blog-images.js) can still require them
