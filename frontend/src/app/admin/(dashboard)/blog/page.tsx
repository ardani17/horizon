 ...
 *
 * Displays blog articles (imported from WordPress) in a data table with search,
 * status filter, and actions for editing, toggling status, and deleting.
 * All API calls are scoped to category=blog.
...
export default function AdminBlogPage() {
  ...
  const toggleStatus = async (article: BlogListItem) => {
  ...
  const deleteArticle = async (article: BlogListItem) => {
