...
import styles from './ArticleLongCard.module.css';
import type { ArticleCardData } from './ArticleCard';

interface ArticleLongCardProps {
...
function getExcerpt(html: string, maxLength = 280): string {
...
/** Card component for long-form article previews */
